...
public abstract class AbstractFlightPlan implements FlightPlan {
	...
	/*Gassa for debug*/
	private int currBlockNumber;
	private int currStageNumber;
	...
	public Position3D[] getWPosition3ds(){
		return waypoints;
	}
	...
	public class NavigationBlock {
		...
		protected final void execute() {			
			preCall();
			//System.out.println("Block " + blockNumber + " Stage " + this.currentStage.stageNumber + " executed");
			currBlockNumber = blockNumber;
			currStageNumber = this.currentStage.stageNumber;
