...
public class AltitudeControlTaskHandler implements Runnable {
	...
	public void run() {
		//System.out.println("AltitudeControlTaskHandler start 111");
//		if( !isExe ){
//			System.out.println("start: Thread_" + AltitudeControlTaskConf.PRIORITY+" : " + Thread.currentThread().getName());
//			isExe = true;
//		}
		...
		//System.out.println("AltitudeControlTaskHandler done 111");
	}
}
