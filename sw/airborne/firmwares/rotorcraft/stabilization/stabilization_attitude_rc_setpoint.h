...
extern void stabilization_attitude_read_rc_setpoint_eulers_f(struct FloatEulers* sp,
...
extern void stabilization_attitude_read_rc_setpoint_quat_f(struct FloatQuat* q_sp, bool_t in_flight,
    bool_t in_carefree, bool_t coordinated_turn);
extern void stabilization_attitude_read_rc_setpoint_quat_earth_bound_f(struct FloatQuat* q_sp,
    bool_t in_flight, bool_t in_carefree, bool_t coordinated_turn);
