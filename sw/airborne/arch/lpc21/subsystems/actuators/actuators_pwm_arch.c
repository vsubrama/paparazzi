...
#if defined PWM_SERVO_0
  PWM_SERVO_0_PINSEL = (PWM_SERVO_0_PINSEL & PWM_SERVO_0_PINSEL_MASK) | PWM_SERVO_0_PINSEL_VAL <<
                       PWM_SERVO_0_PINSEL_BIT;
#endif
#if defined PWM_SERVO_1
  PWM_SERVO_1_PINSEL = (PWM_SERVO_1_PINSEL & PWM_SERVO_1_PINSEL_MASK) | PWM_SERVO_1_PINSEL_VAL <<
                       PWM_SERVO_1_PINSEL_BIT;
#endif
#if defined PWM_SERVO_2
  PWM_SERVO_2_PINSEL = (PWM_SERVO_2_PINSEL & PWM_SERVO_2_PINSEL_MASK) | PWM_SERVO_2_PINSEL_VAL <<
                       PWM_SERVO_2_PINSEL_BIT;
#endif
#if defined PWM_SERVO_3
  PWM_SERVO_3_PINSEL = (PWM_SERVO_3_PINSEL & PWM_SERVO_3_PINSEL_MASK) | PWM_SERVO_3_PINSEL_VAL <<
                       PWM_SERVO_3_PINSEL_BIT;
#endif
#if defined PWM_SERVO_4
  PWM_SERVO_4_PINSEL = (PWM_SERVO_4_PINSEL & PWM_SERVO_4_PINSEL_MASK) | PWM_SERVO_4_PINSEL_VAL <<
                       PWM_SERVO_4_PINSEL_BIT;
#endif
#if defined PWM_SERVO_5
  PWM_SERVO_5_PINSEL = (PWM_SERVO_5_PINSEL & PWM_SERVO_5_PINSEL_MASK) | PWM_SERVO_5_PINSEL_VAL <<
                       PWM_SERVO_5_PINSEL_BIT;
#endif
