...
void stabilization_rate_read_rc(void)
{
  ...
  if (ROLL_RATE_DEADBAND_EXCEEDED()) {
    stabilization_rate_sp.p = (int32_t)radio_control.values[RADIO_ROLL] * STABILIZATION_RATE_SP_MAX_P /
                              MAX_PPRZ;
  } else {
  ...
  if (PITCH_RATE_DEADBAND_EXCEEDED()) {
    stabilization_rate_sp.q = (int32_t)radio_control.values[RADIO_PITCH] * STABILIZATION_RATE_SP_MAX_Q /
                              MAX_PPRZ;
  } else {
  ...
  if (YAW_RATE_DEADBAND_EXCEEDED() && !THROTTLE_STICK_DOWN()) {
    stabilization_rate_sp.r = (int32_t)radio_control.values[RADIO_YAW] * STABILIZATION_RATE_SP_MAX_R /
                              MAX_PPRZ;
  } else {
...
void stabilization_rate_read_rc_switched_sticks(void)
{
  ...
  if (ROLL_RATE_DEADBAND_EXCEEDED()) {
    stabilization_rate_sp.r = (int32_t) - radio_control.values[RADIO_ROLL] *
  ...
  if (YAW_RATE_DEADBAND_EXCEEDED() && !THROTTLE_STICK_DOWN()) {
    stabilization_rate_sp.p = (int32_t)radio_control.values[RADIO_YAW] * STABILIZATION_RATE_SP_MAX_R /
                              MAX_PPRZ;
  } else {
    stabilization_rate_sp.p = 0;
  }
...
void stabilization_rate_run(bool_t in_flight)
{
  ...
  RATES_EWMULT_RSHIFT(stabilization_rate_ff_cmd, stabilization_rate_ddgain, stabilization_rate_refdot,
                      9);
