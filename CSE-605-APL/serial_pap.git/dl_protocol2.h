...
static inline void DOWNLINK_SEND_GPS_INT(struct DownlinkTransport *tp, uint8_t *_gps_id, uint8_t *_ac_id, int32_t *ecef_x, int32_t *ecef_y,
                                         int32_t *ecef_z, int32_t *lat, int32_t *lon, int32_t *alt, int32_t *hmsl, int32_t *ecef_xd,
                                         int32_t *ecef_yd, int32_t *ecef_zd, int32_t *pacc, int32_t *sacc, int32_t *tow, int16_t *pdop, uint8_t *numsv, uint8_t *fix){
    if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+1+1+4+4+4+4+4+4+4+4+4+4+4+4+4+2+1+1))) {
        tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+1+1+4+4+4+4+4+4+4+4+4+4+4+4+4+2+1+1));
        tp->StartMessage(tp->impl, "GPS_INT", DL_GPS_INT, 0+1+1+4+4+4+4+4+4+4+4+4+4+4+4+4+2+1+1);
        tp->PutBytes(tp->impl,DL_TYPE_UINT8, 1, (void*)_gps_id);
        tp->PutBytes(tp->impl,DL_TYPE_UINT8, 1, (void*)_ac_id);
        tp->PutBytes(tp->impl,DL_TYPE_INT32, 4, (void*)ecef_x);
        tp->PutBytes(tp->impl,DL_TYPE_INT32, 4, (void*)ecef_y);
        tp->PutBytes(tp->impl,DL_TYPE_INT32, 4, (void*)ecef_z);
        tp->PutBytes(tp->impl,DL_TYPE_INT32, 4, (void*)lat);
        tp->PutBytes(tp->impl,DL_TYPE_INT32, 4, (void*)lon);
        tp->PutBytes(tp->impl,DL_TYPE_INT32, 4, (void*)alt);
        tp->PutBytes(tp->impl,DL_TYPE_INT32, 4, (void*)hmsl);
        tp->PutBytes(tp->impl,DL_TYPE_INT32, 4, (void*)ecef_xd);
        tp->PutBytes(tp->impl,DL_TYPE_INT32, 4, (void*)ecef_yd);
        tp->PutBytes(tp->impl,DL_TYPE_INT32, 4, (void*)ecef_zd);
        tp->PutBytes(tp->impl,DL_TYPE_INT32, 4, (void*)pacc);
        tp->PutBytes(tp->impl,DL_TYPE_INT32, 4, (void*)sacc);
        tp->PutBytes(tp->impl,DL_TYPE_INT32, 4, (void*)tow);
        tp->PutBytes(tp->impl,DL_TYPE_INT16, 2, (void*)pdop);
        tp->PutBytes(tp->impl,DL_TYPE_UINT8, 1, (void*)numsv);
        tp->PutBytes(tp->impl,DL_TYPE_UINT8, 1, (void*)fix);
        tp->EndMessage(tp->impl);
    } else
        tp->Overrun(tp->impl);
}
...
static inline void DOWNLINK_SEND_AHRS_LTP(struct DownlinkTransport *tp, uint8_t *_gps_id, uint8_t *_ac_id, double *qi, double *qx, double *qy, double *qz){
    if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+1+1+8+8+8+8))) {
        tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+1+1+8+8+8+8));
        tp->StartMessage(tp->impl, "AHRS_LTP", DL_AHRS_LTP, 0+1+1+8+8+8+8);
        tp->PutBytes(tp->impl,DL_TYPE_UINT8, 1, (void*)_gps_id);
        tp->PutBytes(tp->impl,DL_TYPE_UINT8, 1, (void*)_ac_id);
        tp->PutBytes(tp->impl,DL_TYPE_DOUBLE, 8, (void*)qi);
        tp->PutBytes(tp->impl,DL_TYPE_DOUBLE, 8, (void*)qx);
        tp->PutBytes(tp->impl,DL_TYPE_DOUBLE, 8, (void*)qy);
        tp->PutBytes(tp->impl,DL_TYPE_DOUBLE, 8, (void*)qz);
        tp->EndMessage(tp->impl);
    } else
        tp->Overrun(tp->impl);
}

static inline void DOWNLINK_SEND_AHRS_ECEF(struct DownlinkTransport *tp, uint8_t *_gps_id, uint8_t *_ac_id, double *p, double *q, double *r){
    if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+1+1+8+8+8))) {
        tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+1+1+8+8+8));
        tp->StartMessage(tp->impl, "AHRS_ECEF", DL_AHRS_ECEF, 0+1+1+8+8+8);
        tp->PutBytes(tp->impl,DL_TYPE_UINT8, 1, (void*)_gps_id);
        tp->PutBytes(tp->impl,DL_TYPE_UINT8, 1, (void*)_ac_id);
        tp->PutBytes(tp->impl,DL_TYPE_DOUBLE, 8, (void*)p);
        tp->PutBytes(tp->impl,DL_TYPE_DOUBLE, 8, (void*)q);
        tp->PutBytes(tp->impl,DL_TYPE_DOUBLE, 8, (void*)r);
        tp->EndMessage(tp->impl);
    } else
        tp->Overrun(tp->impl);
}

static inline void DOWNLINK_SEND_INS_POS(struct DownlinkTransport *tp, uint8_t *_gps_id, uint8_t *_ac_id, double *p, double *q, double *r){
    if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+1+1+8+8+8))) {
        tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+1+1+8+8+8));
        tp->StartMessage(tp->impl, "DL_INS_POS", DL_INS_POS, 0+1+1+8+8+8);
        tp->PutBytes(tp->impl,DL_TYPE_UINT8, 1, (void*)_gps_id);
        tp->PutBytes(tp->impl,DL_TYPE_UINT8, 1, (void*)_ac_id);
        tp->PutBytes(tp->impl,DL_TYPE_DOUBLE, 8, (void*)p);
        tp->PutBytes(tp->impl,DL_TYPE_DOUBLE, 8, (void*)q);
...
static inline void DOWNLINK_SEND_INS_ECEF_VEL(struct DownlinkTransport *tp, uint8_t *_gps_id, uint8_t *_ac_id, double *p, double *q, double *r){
    if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+1+1+8+8+8))) {
        tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+1+1+8+8+8));
        tp->StartMessage(tp->impl, "DL_INS_ECEF_VEL", DL_INS_ECEF_VEL, 0+1+1+8+8+8);
        tp->PutBytes(tp->impl,DL_TYPE_UINT8, 1, (void*)_gps_id);
        tp->PutBytes(tp->impl,DL_TYPE_UINT8, 1, (void*)_ac_id);
        tp->PutBytes(tp->impl,DL_TYPE_DOUBLE, 8, (void*)p);
        tp->PutBytes(tp->impl,DL_TYPE_DOUBLE, 8, (void*)q);
...
static inline void DOWNLINK_SEND_INS_ECEF_ACCEL(struct DownlinkTransport *tp, uint8_t *_gps_id, uint8_t *_ac_id, double *p, double *q, double *r){
    if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+1+1+8+8+8))) {
        tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+1+1+8+8+8));
        tp->StartMessage(tp->impl, "DL_INS_ECEF_ACCEL", DL_INS_ECEF_ACCEL, 0+1+1+8+8+8);
        tp->PutBytes(tp->impl,DL_TYPE_UINT8, 1, (void*)_gps_id);
        tp->PutBytes(tp->impl,DL_TYPE_UINT8, 1, (void*)_ac_id);
        tp->PutBytes(tp->impl,DL_TYPE_DOUBLE, 8, (void*)p);
        tp->PutBytes(tp->impl,DL_TYPE_DOUBLE, 8, (void*)q);
...
static inline void DOWNLINK_SEND_NPS_SENSORS_GYRO(struct DownlinkTransport *tp, uint8_t *_gps_id, uint8_t *_ac_id, double *x, double *y, double *z){
    if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+1+1+8+8+8))) {
        tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+1+1+8+8+8));
        tp->StartMessage(tp->impl, "DL_NPS_SENSORS_GYRO", DL_NPS_SENSORS_GYRO, 0+1+1+8+8+8);
        tp->PutBytes(tp->impl,DL_TYPE_UINT8, 1, (void*)_gps_id);
        tp->PutBytes(tp->impl,DL_TYPE_UINT8, 1, (void*)_ac_id);
        tp->PutBytes(tp->impl,DL_TYPE_DOUBLE, 8, (void*)x);
        tp->PutBytes(tp->impl,DL_TYPE_DOUBLE, 8, (void*)y);
        tp->PutBytes(tp->impl,DL_TYPE_DOUBLE, 8, (void*)z);
        tp->EndMessage(tp->impl);
    } else
        tp->Overrun(tp->impl);
}

static inline void DOWNLINK_SEND_NPS_SENSORS_ACCEL(struct DownlinkTransport *tp, uint8_t *_gps_id, uint8_t *_ac_id, double *x, double *y, double *z){
    if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+1+1+8+8+8))) {
        tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+1+1+8+8+8));
        tp->StartMessage(tp->impl, "DL_NPS_SENSORS_ACCEL", DL_NPS_SENSORS_ACCEL, 0+1+1+8+8+8);
        tp->PutBytes(tp->impl,DL_TYPE_UINT8, 1, (void*)_gps_id);
        tp->PutBytes(tp->impl,DL_TYPE_UINT8, 1, (void*)_ac_id);
        tp->PutBytes(tp->impl,DL_TYPE_DOUBLE, 8, (void*)x);
        tp->PutBytes(tp->impl,DL_TYPE_DOUBLE, 8, (void*)y);
