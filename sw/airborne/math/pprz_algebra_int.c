 ...
 * rb = m_b2a^T * ra
 */
void int32_rmat_transp_ratemult(struct Int32Rates* rb, struct Int32RMat* m_b2a,
...
void int32_rmat_of_quat(struct Int32RMat* rm, struct Int32Quat* q)
{
  ...
  const int32_t _2qiqx = INT_MULT_RSHIFT(q->qi, q->qx,
                                         INT32_QUAT_FRAC + INT32_QUAT_FRAC - INT32_TRIG_FRAC - 1);
  const int32_t _2qiqy = INT_MULT_RSHIFT(q->qi, q->qy,
                                         INT32_QUAT_FRAC + INT32_QUAT_FRAC - INT32_TRIG_FRAC - 1);
  const int32_t _2qiqz = INT_MULT_RSHIFT(q->qi, q->qz,
                                         INT32_QUAT_FRAC + INT32_QUAT_FRAC - INT32_TRIG_FRAC - 1);
...
void int32_quat_comp_norm_shortest(struct Int32Quat* a2c, struct Int32Quat* a2b,
...
void int32_quat_comp_inv_norm_shortest(struct Int32Quat* a2b, struct Int32Quat* a2c,
                                       struct Int32Quat* b2c)
{
...
void int32_quat_inv_comp_norm_shortest(struct Int32Quat* b2c, struct Int32Quat* a2b,
...
void int32_quat_integrate_fi(struct Int32Quat* q, struct Int64Quat* hr, struct Int32Rates* omega,
                             int freq)
{
  hr->qi += - ((int64_t) omega->p) * q->qx - ((int64_t) omega->q) * q->qy - ((
              int64_t) omega->r) * q->qz;
  hr->qx += ((int64_t) omega->p) * q->qi + ((int64_t) omega->r) * q->qy - ((
              int64_t) omega->q) * q->qz;
  hr->qy += ((int64_t) omega->q) * q->qi - ((int64_t) omega->r) * q->qx + ((
              int64_t) omega->p) * q->qz;
  hr->qz += ((int64_t) omega->r) * q->qi + ((int64_t) omega->q) * q->qx - ((
              int64_t) omega->p) * q->qy;
...
void int32_quat_vmult(struct Int32Vect3* v_out, struct Int32Quat* q, struct Int32Vect3* v_in)
{
  ...
  v_out->x = (_2qi2_m1 * v_in->x + _2qx2 * v_in->x + m01 * v_in->y +  m02 * v_in->z) >>
             INT32_QUAT_FRAC;
  v_out->y = (_2qi2_m1 * v_in->y + m01 * v_in->x - 2 * _2qiqz * v_in->x + _2qy2 * v_in->y + m12 *
              v_in->z) >>
             INT32_QUAT_FRAC;
  v_out->z = (_2qi2_m1 * v_in->z + m02 * v_in->x + 2 * _2qiqy * v_in->x + m12 * v_in->y - 2 * _2qiqx *
              v_in->y + _2qz2 *
...
void int32_rates_of_eulers_dot_321(struct Int32Rates* r, struct Int32Eulers* e,
                                   struct Int32Eulers* ed)
{
  ...
  r->q = INT_MULT_RSHIFT(sphi_ctheta, ed->psi, INT32_TRIG_FRAC) + INT_MULT_RSHIFT(cphi, ed->theta,
         INT32_TRIG_FRAC);
  r->r = INT_MULT_RSHIFT(cphi_ctheta, ed->psi, INT32_TRIG_FRAC) - INT_MULT_RSHIFT(sphi, ed->theta,
         INT32_TRIG_FRAC);
}

void int32_eulers_dot_321_of_rates(struct Int32Eulers* ed, struct Int32Eulers* e,
                                   struct Int32Rates* r)
{
  int32_t sphi;
  PPRZ_ITRIG_SIN(sphi, e->phi);
  ...
  if (ctheta != 0) {
    ...
    ed->phi = r->p + (int32_t)((sphi_stheta * (int64_t)r->q) / ctheta) + (int32_t)((cphi_stheta *
              (int64_t)r->r) / ctheta);
    ed->theta = INT_MULT_RSHIFT(cphi, r->q, INT32_TRIG_FRAC) - INT_MULT_RSHIFT(sphi, r->r,
                INT32_TRIG_FRAC);
    ed->psi = (int32_t)(((int64_t)sphi * (int64_t)r->q) / ctheta) + (int32_t)(((int64_t)cphi *
              (int64_t)r->r) / ctheta);
  }
