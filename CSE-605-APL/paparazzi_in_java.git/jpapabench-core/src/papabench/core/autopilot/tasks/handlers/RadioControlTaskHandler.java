...
public class RadioControlTaskHandler implements Runnable {
	...
	public void run() {
//		if( !isExe ){
//			System.out.println("start: Thread_" + RadioControlTaskConf.PRIORITY+" : " + Thread.currentThread().getName());
//			isExe = true;
//		}
		...
		AutopilotMode autopilotMode = autopilotModule.getAutopilotMode();//just auto2
