...
static bool_t cyrf6936_write_register(struct Cyrf6936* cyrf, const uint8_t addr,
                                      const uint8_t data);
 ...
 */
void cyrf6936_init(struct Cyrf6936* cyrf, struct spi_periph* spi_p, const uint8_t slave_idx,
