...
public class StabilizationTaskHandler implements Runnable {	
	...
	public void run() {
//		if( !isExe ){
//			System.out.println("start: Thread_" + StabilizationTaskConf.PRIORITY+" : " + Thread.currentThread().getName());
//			isExe = true;
//		}
		//System.out.print("StabilizationTaskHandler start");
		...
		//why is this slove problem???
		//System.out.println("stab ==> Sending msg: " + msg);
		//DEBUG
		//System.out.println("DEBUG::stab send msg");
		//System.out.println("stab ==> " + msg.toString());
		autopilotModule.getLinkToFBW().sendMessageToFBW(msg);
		//System.out.println("... StabilizationTaskHandler done");
	}
}
