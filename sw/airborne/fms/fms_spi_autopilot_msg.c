...
void spi_ap_link_set_pressure_absolute_callback(void (* pressure_absolute_cb)(uint8_t pressure_id,
    uint32_t pressure))
{
  pressure_absolute_callback = pressure_absolute_cb;
}

void spi_ap_link_set_pressure_differential_callback(void (* pressure_differential_cb)(
      uint8_t pressure_id, uint32_t pressure))
{
