...
struct Imu {
  struct Int32Rates
      gyro;             ///< gyroscope measurements in rad/s in BFP with #INT32_RATE_FRAC
  struct Int32Vect3
      accel;            ///< accelerometer measurements in m/s^2 in BFP with #INT32_ACCEL_FRAC
  struct Int32Vect3
      mag;              ///< magnetometer measurements scaled to 1 in BFP with #INT32_MAG_FRAC
