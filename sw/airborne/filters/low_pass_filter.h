 ...
 */
static inline void init_first_order_low_pass(struct FirstOrderLowPass* filter, float tau,
...
{
  float out = (value + filter->last_in + (filter->time_const - 1.0f) * filter->last_out) /
 ...
 * @param value initial value of the filter
 */
static inline void init_second_order_low_pass(struct SecondOrderLowPass* filter, float tau, float Q,
    float sample_time, float value)
{
 ...
 * @param value initial value of the filter
 */
static inline void init_second_order_low_pass_int(struct SecondOrderLowPass_int* filter,
    float cut_off, float Q, float sample_time, int32_t value)
{
 ...
 * @return new filtered value
 */
static inline int32_t update_second_order_low_pass_int(struct SecondOrderLowPass_int* filter,
    int32_t value)
{
 ...
 * @param value initial value of the filter
 */
static inline void init_butterworth_2_low_pass(Butterworth2LowPass* filter, float tau,
    float sample_time, float value)
{
 ...
 * @param value initial value of the filter
 */
static inline void init_butterworth_2_low_pass_int(Butterworth2LowPass_int* filter, float cut_off,
    float sample_time, int32_t value)
{
  init_second_order_low_pass_int((struct SecondOrderLowPass_int*)filter, cut_off, 0.7071, sample_time,
                                 value);
}
 ...
 * @return new filtered value
 */
static inline int32_t update_butterworth_2_low_pass_int(Butterworth2LowPass_int* filter,
    int32_t value)
{
 ...
 * @param value initial value of the filter
 */
static inline void init_butterworth_4_low_pass(Butterworth4LowPass* filter, float tau,
    float sample_time, float value)
{
 ...
 * @param value initial value of the filter
 */
static inline void init_butterworth_4_low_pass_int(Butterworth4LowPass_int* filter, float cut_off,
    float sample_time, int32_t value)
{
 ...
 * @return new filtered value
 */
static inline int32_t update_butterworth_4_low_pass_int(Butterworth4LowPass_int* filter,
    int32_t value)
{
