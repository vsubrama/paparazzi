...
extern float
failsafe_mode_dist2; ///< maximum squared distance to home wp before going to failsafe mode
...
extern void navigation_update_wp_from_speed(uint8_t wp, struct Int16Vect3 speed_sp,
